...
cmake .. -DTON_SDK_VERSION=%TON_SDK_VERSION% -DTON_SDK_BRANCH=%TON_SDK_BRANCH% -DTON_SDK_TARGET="%TON_SDK_TARGET%" -DCMAKE_INSTALL_PREFIX="%INSTALL_DIR%" -G "NMake Makefiles" -DCMAKE_BUILD_TYPE=Release
