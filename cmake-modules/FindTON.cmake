...
find_package_handle_standard_args(TON REQUIRED_VARS TON_LIBRARY TON_INCLUDE_DIR VERSION_VAR TON_SDK_VERSION)
...
IF (TON_FOUND)
    ...
    if (NOT TARGET TON::Client)
        ...
        set_target_properties(TON::Client PROPERTIES
                INTERFACE_INCLUDE_DIRECTORIES "${TON_INCLUDE_DIR}"
                IMPORTED_LINK_INTERFACE_LANGUAGES "C"
                IMPORTED_LOCATION "${TON_LIBRARY}")
        if (WIN32)
